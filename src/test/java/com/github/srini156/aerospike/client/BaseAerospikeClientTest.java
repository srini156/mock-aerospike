...
public abstract class BaseAerospikeClientTest {
    ...
    protected Key key5 = new Key(namespace, set, "Key5");
    ...
    public void shouldOperateRecord() {
        Record record = aerospikeClient.operate(
                null, key5, Operation.put(new Bin("test1", "test")), Operation.put(new Bin("test2", "test"))
        );
        assertNotNull(record);
        Record updatedRecord = aerospikeClient.get(null, key5);
        assertTrue(updatedRecord.bins.containsKey("test1"));
        assertTrue(updatedRecord.bins.containsKey("test2"));
    }
    ...
    public void shouldAddRecord() {
        aerospikeClient.put(null, key4, new Bin("third", 1L));
        Record record = aerospikeClient.get(null, key4);
        assertNotNull(record);
        assertTrue(record.bins.containsKey("third"));
        assertEquals(record.bins.get("third"), 1L);
        aerospikeClient.add(null, key4, new Bin("third", 1L));
        assertEquals(aerospikeClient.get(null, key4).bins.get("third"), 2L);

        // Undo changes
        aerospikeClient.get(null, key4).bins.put("third", 1L);
    }
    ...
    public void tearDown() {
        ...
        aerospikeClient.delete(null, key2);
        aerospikeClient.delete(null, key3);
        aerospikeClient.delete(null, key4);
        aerospikeClient.delete(null, key5);
